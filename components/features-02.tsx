                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div className="relative p-4 w-full h-64 md:h-auto overflow-hidden">
                        <Image
                          className="absolute w-full bottom-0 mx-auto max-w-none md:relative md:left-0{md}transla{}-x-0"
                          src={FeatureImg01}
                          alt="Feature 01"
                        />
                      </div>
