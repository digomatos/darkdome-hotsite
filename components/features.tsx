...
import Illustration from "@/public/images/glow-top-dd.svg";
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                <p className="text-lg text-slate-400 mb-8">
                  Darkdome brings all your cybersecurity alerts together in one
                  AI-powered console, delivering real-time analysis and
                ...
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded-sm border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 1
                        ...
                        : "border-blue-700 shadow-sm shadow-blue-500/25"
                    }`}
                    onClick={() => setTab(1)}
                  >
                    <svg
                    ...
                    <span>Centralizes your security alerts</span>
                  </button>
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded-sm border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 2
                  ...
                  >
                    ...
                    <span>Automated protection setup</span>
                  </button>
                </div>
              </div>
